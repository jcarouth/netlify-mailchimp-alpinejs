<div class="max-w-4xl md:flex mx-auto py-8 md:space-x-6">
    ...
    <div class="w-full md:w-3/5 mt-8 md:mt-0 flex flex-col justify-center">
        <form x-data="newsletter()" x-init="init()" name="newsletter-subscribes" method="POST" action="/" data-netlify="true">
            ...
            <div :class="{ 'animate-pulse': loading }" class="flex">
                ...
                <input type="hidden" name="listId" value="{{ env('MAILCHIMP_LIST_ID', 'missing') }}">
